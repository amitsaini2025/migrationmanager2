...
return new class extends Migration
{
    public function up(): void
    {
        Schema::connection('second_db')->table('emails', function (Blueprint $table) {
            if (!Schema::hasColumn('emails', 'email_user_id')) {
                $table->unsignedBigInteger('email_user_id')->nullable()->after('account_id');
            }
    ...
    public function down(): void
    {
        Schema::connection('second_db')->table('emails', function (Blueprint $table) {
            ...
            if (Schema::hasColumn('emails', 'email_user_id')) $table->dropColumn('email_user_id');
        });
    }
};
