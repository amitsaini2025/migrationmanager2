<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <a href="{{ route('email_users.signatures.index', ['account_id' => $signature->account_id]) }}" 
    ...
    <div class="py-6">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <form method="POST" action="{{ route('email_users.signatures.update', $signature) }}" class="space-y-6">
                        @csrf
                        @method('PUT')
