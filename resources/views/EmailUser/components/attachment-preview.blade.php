...
<div class="attachment-item bg-white border border-gray-200 rounded-lg p-4 hover:shadow-md transition-shadow">
    <div class="flex items-start justify-between">
        ...
        <div class="flex items-center space-x-2 ml-4">
            ...
            <a 
                href="{{ route('email_users.attachments.download', $attachment->id) }}"
                class="inline-flex items-center px-3 py-1.5 border border-gray-300 shadow-sm text-xs font-medium rounded text-gray-700 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500"
    ...
    <div class="relative top-20 mx-auto p-5 border w-11/12 max-w-4xl shadow-lg rounded-md bg-white">
        <div class="mt-3">
            ...
            <div class="max-h-96 overflow-auto">
                @if($attachment->isImage())
                    <img 
                        src="{{ route('email_users.attachments.view', $attachment->id) }}" 
                ...
                @elseif($attachment->isPdf())
                    <iframe 
                        src="{{ route('email_users.attachments.view', $attachment->id) }}#toolbar=0&navpanes=0&scrollbar=0"
