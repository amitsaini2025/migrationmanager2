...
class SignatureController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('EmailUser.signatures.index', compact('signatures', 'accounts', 'accountId'));
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('EmailUser.signatures.create', compact('accounts', 'accountId', 'templates', 'selectedTemplate', 'templateType'));
    }
    ...
    public function store(Request $request)
    {
        ...
        $validated['user_id'] = Auth::guard('email_users')->id();
        ...
        if ($validated['is_default'] ?? false) {
            EmailSignature::where('user_id', Auth::guard('email_users')->id())
        ...
        return redirect()->route('email_users.signatures.index', ['account_id' => $validated['account_id']])
    ...
    public function show(EmailSignature $signature)
    {
        ...
        return view('EmailUser.signatures.show', compact('signature'));
    }
    ...
    public function edit(EmailSignature $signature)
    {
        ...
        return view('EmailUser.signatures.edit', compact('signature', 'accounts'));
    }
    ...
    public function destroy(EmailSignature $signature)
    {
        ...
        return redirect()->route('email_users.signatures.index')
    ...
    public function preview(EmailSignature $signature)
    {
        ...
        return view('EmailUser.signatures.preview', compact('signature'));
    }
