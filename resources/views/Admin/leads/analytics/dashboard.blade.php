...
function applyDateFilter() {
    ...
    window.location.href = `{{ route('admin.leads.analytics') }}?start_date=${startDate}&end_date=${endDate}`;
}
...
function exportReport() {
    const startDate = document.getElementById('start_date').value;
    const endDate = document.getElementById('end_date').value;
    window.location.href = `{{ route('admin.leads.analytics.export') }}?start_date=${startDate}&end_date=${endDate}`;
}
...
function filterAgents(filter) {
    ...
    window.location.href = '{{ route("admin.leads.analytics") }}?filter=' + filter;
}
</script>
@endsection
