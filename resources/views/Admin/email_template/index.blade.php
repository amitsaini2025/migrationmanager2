					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="text" name="type" value="{{ Request::get('type') }}" class="form-control" data-valid="" autocomplete="off" placeholder="ID" id="type">
								</div>
							</div>
						</div>
						<div class="col-md-6">
							<div class="form-group row">
								...
								<div class="col-sm-10">
									<input type="text" name="name" value="{{ Request::get('name') }}" class="form-control" data-valid="" autocomplete="off" placeholder="Destination Name" id="name">
								</div>
							</div>
						</div>
