...
@section('content')
    <main class="main-content">
        <header class="header dashboard-test-header">
            <div class="header-title-section">
                <h1>Dashboard - TEST PAGE 
                    <span class="test-badge">EXPERIMENTAL</span>
                </h1>
                <p class="test-subtitle">
                    <i class="fas fa-info-circle"></i> 
                    This is a duplicate test page for experiments. Changes here won't affect the production dashboard.
                </p>
            </div>
        ...
        {{-- Quick Stats Banner --}}
        <section class="quick-stats-banner">
            <div class="stat-item">
            ...
            <div class="stat-item">
                ...
                <div>
                    ...
                    <span class="stat-value">{{ rand(5, 15) }}</span>
                </div>
            </div>
        </section>
        ...
        <section class="cases-overview">
            ...
            {{-- Filter Controls --}}
            @include('components.dashboard.filter-form-test', ['filters' => $filters, 'workflowStages' => $workflowStages])
...
.header-title-section .test-subtitle {
    color: #666;
    font-size: 0.9em;
    margin-top: 8px;
    display: flex;
...
<script>
    ...
    window.dashboardRoutes = {
        dashboard: "{{ route('dashboard.test') }}",
...
document.addEventListener('DOMContentLoaded', function() {
    setTimeout(() => {
        showToast('Welcome to the experimental dashboard! Try the new features.', 'success');
    }, 500);
    
    // Add tooltips info
    console.log('%c🚀 Dashboard Test Page', 'font-size: 20px; color: #005792; font-weight: bold;');
