...
<div class="followup-dashboard" style="padding: 20px; max-width: 1400px; margin: 0 auto;">
    <div class="client-header" style="padding-bottom: 20px;">
        ...
        <div class="client-status">
            <a href="{{ route('leads.followups.dashboard') }}" class="btn btn-secondary">
    ...
    <div class="followup-filters">
        <form method="GET" action="{{ route('leads.followups.index') }}">
            ...
            <table>
                ...
                <tbody>
                    @forelse($followups as $followup)
                        <tr>
                            <td>
                                <a href="{{ route('leads.edit', $followup->lead_id) }}">
...
@include('crm.leads.followups.dashboard')
