...
<div class="followup-dashboard">
    ...
    <div class="followup-section">
        ...
        @foreach($overdue as $followup)
            @include('Admin.leads.followups.partials.followup-card', ['followup' => $followup, 'status' => 'overdue'])
        @endforeach
    </div>
    @endif
    ...
    <div class="followup-section">
        ...
        @if($today->count() > 0)
            @foreach($today as $followup)
                @include('Admin.leads.followups.partials.followup-card', ['followup' => $followup, 'status' => 'today'])
            @endforeach
        @else
    ...
    <div class="followup-section">
        ...
        @if($upcoming->count() > 0)
            @foreach($upcoming as $followup)
                @include('Admin.leads.followups.partials.followup-card', ['followup' => $followup, 'status' => 'upcoming'])
            @endforeach
        @else
            <div class="empty-state">
