                ...
                <div class="teams-notification" id="teams-notification-${notification.id}">
                    ...
                    <div class="teams-notification-body">
                        ...
                        <div class="teams-notification-message">
                            ...
                            <strong>Time:</strong> ${typeof formatDisplayDateTime === 'function' ? (formatDisplayDateTime(notification.created_at) || notification.created_at || '') : (notification.created_at || '')}
                        </div>
