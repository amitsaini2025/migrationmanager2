<x-app-layout>
                        ...
                        <div>
                            <div class="flex justify-between items-center mb-2">
                                ...
                                <div class="flex items-center space-x-2">
                                    ...
                                    <a href="{{ route('email_users.signatures.index', ['account_id' => $accountId]) }}" 
                                       target="_blank"
    ...
    <script>
        ...
        function saveDraft() {
            ...
            const url = new URL('{{ route('email_users.emails.save-draft') }}', window.location.origin).toString();
        ...
        function submitCompose(e) {
            ...
            const csrf = document.querySelector('meta[name="csrf-token"]').getAttribute('content');
            const url = new URL('{{ route('email_users.emails.send') }}', window.location.origin).toString();
