...
<script>
    ...
    window.ClientDetailConfig = {
        ...
        urls: {
            ...
            updateClientFundsLedger: '{{ route("crm.clients.update-client-funds-ledger") }}',
            ...
            toggleClientPortal: '{{ route("crm.clients.toggleClientPortal") }}',
            enhanceMail: '{{ route("crm.mail.enhance") }}',
            ...
            generateAgreement: '{{ route("crm.clients.generateagreement") }}',
            ...
            uploadAgreement: '{{ route("crm.clients.uploadAgreement", $fetchedData->id) }}',
