    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="flex space-x-2">
                ...
                <a href="{{ route('email_users.signatures.create', ['account_id' => $accountId]) }}" 
                                ...
                                <div class="border border-gray-200 rounded-lg p-4 hover:bg-gray-50">
                                    <div class="flex justify-between items-start">
                                        ...
                                        <div class="flex space-x-2 ml-4">
                                            <a href="{{ route('email_users.signatures.preview', $signature) }}" 
                                               class="text-green-600 hover:text-green-800 text-sm">
                                                Preview
                                            </a>
                                            <a href="{{ route('email_users.signatures.edit', $signature) }}" 
                                               class="text-blue-600 hover:text-blue-800 text-sm">
                                                Edit
                                            </a>
                                            
                                            @if(!$signature->is_default)
                                                <form method="POST" action="{{ route('email_users.signatures.set-default', $signature) }}" class="inline">
                                                    @csrf
                                                    <button type="submit" 
                                                            class="text-green-600 hover:text-green-800 text-sm">
                                                        Set Default
                                            ...
                                            <form method="POST" action="{{ route('email_users.signatures.toggle', $signature) }}" class="inline">
                                                @csrf
                                                <button type="submit" 
                                            ...
                                            <form method="POST" action="{{ route('email_users.signatures.destroy', $signature) }}" 
                                                  class="inline" 
