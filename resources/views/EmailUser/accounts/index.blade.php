<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="flex gap-2">
                <a href="{{ route('email_users.accounts.create') }}?provider=zoho" 
                                ...
                                <div class="bg-white border border-gray-200 rounded-lg shadow-md p-6 hover:shadow-lg transition-shadow">
                                    ...
                                    <div class="flex justify-between items-center">
                                        ...
                                        <div class="flex space-x-2">
                                            ...
                                            <form action="{{ route('email_users.accounts.destroy', $account) }}" 
                                                  method="POST" 
                                                  class="inline"
    ...
    <script>
        function testConnection(accountId) {
            ...
            fetch(`/email_users/accounts/${accountId}/test-connection`, {
                method: 'POST',
                headers: {
