...
class AccountTabDibpReceiptsToggleTest extends TestCase
{
    ...
    public function account_tab_receipts_panel_is_a_visa_like_table_shell_with_unique_ids(): void
    {
        ...
        Assert::assertStringContainsString('data-unused-url', $panel);
        Assert::assertStringContainsString('id="dibp-receipts-unused"', $panel);
        Assert::assertStringContainsString('$dibp_receipts_unused_lists', $panel);
    ...
    public function account_tab_script_toggles_receipts_panel_with_hidden_attribute(): void
    {
        ...
        Assert::assertStringContainsString('dibp-receipts-unused', $js);
